<%@ Control Language="VB" CodeBehind="LogonCustom.ascx.vb" ClassName="LogonCustom" Inherits="LogonCustom"%>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td class="ViewCaption">
                    <h1>
                        <cc4:ViewCaptionControl ID="VCC" DetailViewCaptionMode="ViewCaption"
                            runat="server" />
                    </h1>
                </td>
            </tr>
