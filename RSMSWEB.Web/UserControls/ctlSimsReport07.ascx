<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlSimsReport07.ascx.vb" Inherits=".ctlSimsReport07" %>
...
<script type="text/javascript" id="dxss_script07">
...
<div id="div_main">
    <div id="div_search_panel">
        <dx:ASPxRoundPanel ID="HeaderPanel" ShowHeader="true" EnableAnimation="true"
            ...
            HeaderText="เมล็ดพันธุ์ : X-3-XX-X-X-XXXX-X-XXX" runat="server" Width="100%" ClientVisible="True" Collapsed="True">
