...
Public Class ctlSimsReport10
    ...
    Public Sub LoadData()
        Try
            ...
            Dim cmd As String = "SP_Sims_Report10_SaleSeedAgent"
    ...
    Protected Sub btnExportData_Click(sender As Object, e As EventArgs) Handles btnExportData.Click
        LoadData()
        ASPxGridViewExporter1.WriteXlsToResponse(Date.Today.ToString("ddMMyy") & "_รายงานการจำหน่ายเมล็ดพันธุ์ผ่านตัวแทน", True)
    End Sub
