<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlSimsReport04.ascx.vb" Inherits=".ctlSimsReport04" %>
...
<script type="text/javascript" id="dxss_script04">
        ...
        <PanelCollection>
            <dx:PanelContent>
                ...
                <div id="divGridDisplay" style="padding: 5px; width: 1019px; overflow: auto; white-space: nowrap;">
                    <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False" SettingsPager-PageNumberFormat="{0}">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="ประเภท" FieldName="TransactionType" VisibleIndex="8" Name="TransactionType">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="เลขที่การจ่าย" FieldName="RefNo" VisibleIndex="9" Name="RefNo">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="วันที่จ่ายเมล็ดพันธุ์" Name="TransactionDate" FieldName="TransactionDate" VisibleIndex="10">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                <DataItemTemplate>
                                    <%#DataUtil.GatDateString(Eval("TransactionDate"))%>
                                </DataItemTemplate>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="น้ำหนัก (กก.)" Name="Quantity" FieldName="Quantity" VisibleIndex="11">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
