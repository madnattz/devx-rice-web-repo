<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlSimsReport10.ascx.vb" Inherits=".ctlSimsReport10" %>
...
<script type="text/javascript" id="dxss_script10">
                        ...
                        <div style="margin-left: 5px; padding: 5px;">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="cmbSite" runat="server" ValueType="System.String">
                ...
                <div id="divGridDisplay" style="padding: 5px; width: 1019px; overflow: auto; white-space: nowrap;">
                    <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="น้ำหนัก<br />(กก.)" FieldName="Quantity" VisibleIndex="9" Name="Quantity">
                                <PropertiesTextEdit DisplayFormatString="N0">
                                </PropertiesTextEdit>
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="จำหน่ายส่วนลด<br />(%)" FieldName="DiscountPercentage" VisibleIndex="10" Name="DiscountPercentage">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                        </Columns>
