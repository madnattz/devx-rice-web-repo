<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlSimsReport03.ascx.vb" Inherits=".ctlSimsReport03" %>
...
<script type="text/javascript" id="dxss_script03">
                ...
                <div id="divGridDisplay" style="padding: 5px; width: 1019px; overflow: auto; white-space: nowrap;">
                    <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="ความงอก<br />เฉลี่ย" FieldName="SeedGrowValue" VisibleIndex="12" Name="SeedGrowValue">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                        </Columns>
