<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlSimsReport13.ascx.vb" Inherits=".ctlSimsReport13" %>
...
<script type="text/javascript" id="dxss_script13">
                        ...
                        <div style="margin-left: 5px; padding: 5px;">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="cmbTransferSite" runat="server" ValueType="System.String"></dx:ASPxComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: right">
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="cmbTransferReason" runat="server" ValueType="System.String">
                                            <Items>
                                                <dx:ListEditItem Text="ทั้งหมด" Value="-1" Selected="true" />
                                                <dx:ListEditItem Text="จำหน่าย" Value="1" />
                                                <dx:ListEditItem Text="จัดทำแปลง" Value="2" />
                                            </Items>
                                        </dx:ASPxComboBox>
                                    </td>
                                </tr>
            ...
            <dx:PanelContent>
                ...
                <div id="divGridDisplay" style="padding: 5px; width: 1019px; overflow: auto; white-space: nowrap;">
                    <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn Caption="ศูนย์ที่จ่ายโอน" FieldName="SiteNameFrom" VisibleIndex="0" Name="SiteNameFrom">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="ศูนย์ที่รับโอน" FieldName="SiteNameTo" VisibleIndex="1" Name="SiteNameTo">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn Caption="วันที่จ่ายโอน" Name="TransferDate" FieldName="TransferDate" VisibleIndex="7">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                <DataItemTemplate>
                                    <%#DataUtil.GatDateString(Eval("TransferDate"))%>
                                </DataItemTemplate>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="วันที่รับโอน" Name="ReceiveDate" FieldName="ReceiveDate" VisibleIndex="8">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                <DataItemTemplate>
                                    <%#DataUtil.GatDateString(Eval("ReceiveDate"))%>
                                </DataItemTemplate>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewBandColumn Caption="โอนเพื่อ" VisibleIndex="9">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="True" />
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="จำหน่าย (กก.)" Name="ForSaleQuantity" FieldName="ForSaleQuantity" VisibleIndex="0">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="จัดทำแปลง (กก.)" Name="ForGrowQuantity" FieldName="ForGrowQuantity" VisibleIndex="1">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                            </dx:GridViewBandColumn>
                            <dx:GridViewDataTextColumn Caption="หมายเหตุ" Name="Remark" FieldName="Remark" VisibleIndex="10">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                        </Columns>
                        ...
                        <TotalSummary>
                            <dx:ASPxSummaryItem FieldName="ForSaleQuantity" ShowInColumn="ForSaleQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="ForGrowQuantity" ShowInColumn="ForGrowQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        </TotalSummary>
