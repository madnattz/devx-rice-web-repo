...
Public Class ctlSimsReport14
    ...
    Public Sub LoadData()
        Try
            ...
            Dim cmd As String = "SP_Sims_Report14_SeedBuyer"
    ...
    Protected Sub btnExportData_Click(sender As Object, e As EventArgs) Handles btnExportData.Click
        LoadData()
        ASPxGridViewExporter1.WriteXlsToResponse(Date.Today.ToString("ddMMyy") & "_ทะเบียนผู้ซื้อเมล็ดพันธุ์", True)
    End Sub
