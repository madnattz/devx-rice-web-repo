<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlSimsReport11.ascx.vb" Inherits=".ctlSimsReport11" %>
...
<script type="text/javascript" id="dxss_script11">
                ...
                <div id="divGridDisplay" style="padding: 5px; width: 1019px; overflow: auto; white-space: nowrap;">
                    <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="พืช" FieldName="PlantName" VisibleIndex="3" Name="PlantName">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="พันธุ์" FieldName="SeedName" VisibleIndex="4" Name="SeedName">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="ชั้นพันธุ์" FieldName="ClassName" VisibleIndex="5" Name="ClassName">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="ฤดู" FieldName="SeasonName" VisibleIndex="6" Name="SeasonName">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="ปี" FieldName="SeedYear" VisibleIndex="7" Name="SeedYear">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewBandColumn Caption="ปริมาณที่จำหน่ายได้" VisibleIndex="8">
                                <HeaderStyle HorizontalAlign="Center" Font-Bold="True" />
                                <Columns>
                                    <dx:GridViewBandColumn Caption="ราคาเต็ม" VisibleIndex="0">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="น้ำหนัก<br />(กก.)" Name="FullPriceQuantity" FieldName="FullPriceQuantity" VisibleIndex="0">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="เป็นเงิน<br />(บาท)" Name="FullPriceAmount" FieldName="FullPriceAmount" VisibleIndex="1">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                                    </dx:GridViewBandColumn>
                                    <dx:GridViewBandColumn Caption="ค่าขนส่ง" VisibleIndex="0">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="น้ำหนัก<br />(กก.)" Name="DeliveryQuantity" FieldName="DeliveryQuantity" VisibleIndex="0">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="เป็นเงิน<br />(บาท)" Name="DeliveryAmount" FieldName="DeliveryAmount" VisibleIndex="1">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                                    </dx:GridViewBandColumn>
                                    <dx:GridViewBandColumn Caption="ราคาส่วนลด 5%" VisibleIndex="0">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="น้ำหนัก<br />(กก.)" Name="Discount5Quantity" FieldName="Discount5Quantity" VisibleIndex="0">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="เป็นเงิน<br />(บาท)" Name="Discount5Amount" FieldName="Discount5Amount" VisibleIndex="1">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                                    </dx:GridViewBandColumn>
                                    <dx:GridViewBandColumn Caption="ราคาส่วนลด 7%" VisibleIndex="0">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="น้ำหนัก<br />(กก.)" Name="Discount7Quantity" FieldName="Discount7Quantity" VisibleIndex="0">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="เป็นเงิน<br />(บาท)" Name="Discount7Amount" FieldName="Discount7Amount" VisibleIndex="1">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                                    </dx:GridViewBandColumn>
                                    <dx:GridViewBandColumn Caption="ราคาส่วนลด 10%" VisibleIndex="0">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="น้ำหนัก<br />(กก.)" Name="Discount10Quantity" FieldName="Discount10Quantity" VisibleIndex="0">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="เป็นเงิน<br />(บาท)" Name="Discount10Amount" FieldName="Discount10Amount" VisibleIndex="1">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                                    </dx:GridViewBandColumn>
                                    <dx:GridViewBandColumn Caption="ราคาอื่นๆ" VisibleIndex="0">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="น้ำหนัก<br />(กก.)" Name="OtherPriceQuantity" FieldName="OtherPriceQuantity" VisibleIndex="0">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="เป็นเงิน<br />(บาท)" Name="OtherPriceAmount" FieldName="OtherPriceAmount" VisibleIndex="1">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                                    </dx:GridViewBandColumn>
                                    <dx:GridViewBandColumn Caption="รวม" VisibleIndex="0">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="น้ำหนัก<br />(กก.)" Name="AllQuantity" FieldName="AllQuantity" VisibleIndex="0">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="เป็นเงิน<br />(บาท)" Name="AllAmont" FieldName="AllAmont" VisibleIndex="1">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                        ...
                        <TotalSummary>
                            <dx:ASPxSummaryItem FieldName="FullPriceQuantity" ShowInColumn="FullPriceQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="FullPriceAmount" ShowInColumn="FullPriceAmount" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="DeliveryQuantity" ShowInColumn="DeliveryQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="DeliveryAmount" ShowInColumn="DeliveryAmount" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="Discount5Quantity" ShowInColumn="Discount5Quantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="Discount5Amount" ShowInColumn="Discount5Amount" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="Discount7Quantity" ShowInColumn="Discount7Quantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="Discount7Amount" ShowInColumn="Discount7Amount" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="Discount10Quantity" ShowInColumn="Discount10Quantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="Discount10Amount" ShowInColumn="Discount10Amount" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="OtherPriceQuantity" ShowInColumn="OtherPriceQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="OtherPriceAmount" ShowInColumn="OtherPriceAmount" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="AllQuantity" ShowInColumn="AllQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                            <dx:ASPxSummaryItem FieldName="AllAmont" ShowInColumn="AllAmont" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        </TotalSummary>
