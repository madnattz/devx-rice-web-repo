...
Public Class ctlSimsReport11
    ...
    Public Sub LoadData()
        Try
            ...
            Dim cmd As String = "SP_Sims_Report11_SaleSeedIncome"
    ...
    Protected Sub btnExportData_Click(sender As Object, e As EventArgs) Handles btnExportData.Click
        LoadData()
        ASPxGridViewExporter1.WriteXlsToResponse(Date.Today.ToString("ddMMyy") & "_รายงานรายรับจากการจำหน่ายเมล็ดพันธุ์", True)
    End Sub
