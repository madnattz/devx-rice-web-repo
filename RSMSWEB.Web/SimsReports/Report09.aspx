<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report09.aspx.vb" Inherits=".Report09" %>
...
<head id="Head1" runat="server">
    <title>รายงานที่ 9 รายงานการจำหน่ายเมล็ดพันธุ์</title>
            ...
            <div style="padding: 5px;">
                ...
                <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="จำหน่ายที่ศูนย์ขยายเมล็ดพันธุ์ข้าว (กก.)" VisibleIndex="6">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            <Columns>
                                <dx:GridViewBandColumn Caption="ส่วนราชการ" VisibleIndex="0">
                                    <Columns>
                                        <dx:GridViewDataTextColumn Caption="โครงการ" Name="ProjectQuantity" FieldName="ProjectQuantity" VisibleIndex="0">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="ประสบภัย" Name="DangerQuantity" FieldName="DangerQuantity" VisibleIndex="1">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="สมาชิก<br />ผู้ผลิตเมล็ดพันธุ์" Name="MemberQuantity" FieldName="MemberQuantity" VisibleIndex="1">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="ตัวแทนจำหน่าย" Name="AgentQuantity" FieldName="AgentQuantity" VisibleIndex="2">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewBandColumn Caption="กลุ่มเกษตรกร/เกษตรทั่วไป" VisibleIndex="3">
                                    <Columns>
                                        <dx:GridViewDataTextColumn Caption="ราคาเต็ม" Name="FullPriceQuantity" FieldName="FullPriceQuantity" VisibleIndex="0">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="ราคาส่วนลด" Name="DiscountPriceQuantity" FieldName="DiscountPriceQuantity" VisibleIndex="1">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="ราคาเฉพาะกิจ" Name="ExtraPriceQuantity" FieldName="ExtraPriceQuantity" VisibleIndex="4">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="ขายทอดตลาด" Name="MarketPriceQuantity" FieldName="MarketPriceQuantity" VisibleIndex="5">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                            </Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="รวมจำหน่าย<br />ทั้งสิ้น<br />(กก.)" Name="TotalQuantity" FieldName="TotalQuantity" VisibleIndex="7">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    ...
                    <TotalSummary>
                        <dx:ASPxSummaryItem FieldName="ProjectQuantity" ShowInColumn="ProjectQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="DangerQuantity" ShowInColumn="DangerQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="MemberQuantity" ShowInColumn="MemberQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="AgentQuantity" ShowInColumn="AgentQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="FullPriceQuantity" ShowInColumn="FullPriceQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="DiscountPriceQuantity" ShowInColumn="DiscountPriceQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="ExtraPriceQuantity" ShowInColumn="ExtraPriceQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="MarketPriceQuantity" ShowInColumn="MarketPriceQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="TotalQuantity" ShowInColumn="TotalQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                    </TotalSummary>
