<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report03.aspx.vb" Inherits=".Report03" %>
...
<head id="Head1" runat="server">
    <title>รายงานที่ 3 บัญชีรายการรับเมล็ดพันธุ์ดี </title>
    ...
    <form id="form1" runat="server">
        ...
        <div id="div_main">
            <div id="div_text_header">
                บัญชีรายการรับเมล็ดพันธุ์ดี 
            </div>
            <div id="div_search_panel">
                <span id="dsh_header">
                    <img id="img1" src="/Images/togleup.gif" style="padding-right: 5px;" title="เปิด" />
                    <label id="lblComment" class="SubHead2">เมล็ดพันธุ์ : X-2-XX-X-X-XXXX-X-XXX</label>
                </span>
                <div id="divSeedID">
                    <table>
                        <tr>
            ...
            <div style="padding: 5px;">
                ...
                <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="รายละเอียดการรับ" FieldName="ReceiveReason" VisibleIndex="9" Name="ReceiveReason">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="วันที่รับเมล็ดพันธุ์" Name="ReceiveDate" FieldName="ReceiveDate" VisibleIndex="10">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            <DataItemTemplate>
                        ...
                        <dx:GridViewBandColumn Caption="น้ำหนัก (กก.)" VisibleIndex="11">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="คลุกสาร" Name="MixChemecalQuantity" FieldName="MixChemecalQuantity" VisibleIndex="0">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="ไม่คลุกสาร" Name="NonChemecalQuantity" FieldName="NonChemecalQuantity" VisibleIndex="1">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="รวม" Name="AllQuantity" FieldName="AllQuantity" VisibleIndex="2">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                            </Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="ความงอกเฉลี่ย" FieldName="SeedGrowValue" VisibleIndex="12" Name="SeedGrowValue">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    ...
                    <TotalSummary>
                        <dx:ASPxSummaryItem FieldName="MixChemecalQuantity" ShowInColumn="MixChemecalQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="NonChemecalQuantity" ShowInColumn="NonChemecalQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
