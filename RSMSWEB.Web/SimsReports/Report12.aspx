<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report12.aspx.vb" Inherits=".Report12" %>
...
<head id="Head1" runat="server">
    <title>รายงานที่ 12 รายงานการจำหน่ายเมล็ดพันธุ์ในพื้นที่ต่างๆ </title>
    ...
    <form id="form1" runat="server">
        <div id="div_main">
            <div id="div_text_header">
                รายงานการจำหน่ายเมล็ดพันธุ์ในพื้นที่ต่างๆ 
            </div>
            ...
            <div style="padding: 5px;">
                ...
                <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="จำหน่ายเมล็ดพันธุ์ให้กับผู้ซื้อ" VisibleIndex="7">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="True" />
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="จังหวัด" Name="ProvinceName" FieldName="ProvinceName" VisibleIndex="0">
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="อำเภอ" Name="DistrictName" FieldName="DistrictName" VisibleIndex="1">
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="ตำบล" Name="SubDistrictName" FieldName="SubDistrictName" VisibleIndex="2">
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dx:GridViewDataTextColumn>
                            </Columns>
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewBandColumn>
                        <dx:GridViewDataTextColumn Caption="น้ำหนัก<br />(กก.)" Name="Quantity" FieldName="Quantity" VisibleIndex="8">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
