<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report01.aspx.vb" Inherits=".Report01" %>
...
<head runat="server">
    <title>รายงานที่ 1 บัญชีรายการรับเมล็ดพันธุ์ซื้อคืน (ดิบ)</title>
    ...
    <form id="form1" runat="server">
        ...
        <div id="div_main">
            <div id="div_text_header">
                บัญชีรายการรับเมล็ดพันธุ์ซื้อคืน (ดิบ)
            </div>
