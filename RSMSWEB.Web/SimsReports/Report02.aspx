<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report02.aspx.vb" Inherits=".Report02" Culture="th-TH" UICulture="th-TH" %>
...
<head id="Head1" runat="server">
    <title>รายงานที่ 2 บัญชีรายการจ่ายเมล็ดพันธุ์ซื้อคืน (ดิบ)</title>
    <script src="/Scripts/jquery/jquery.js" type="text/javascript"></script>
    <script id="dxis_xxxddd" src="/Scripts/THDateEdit.js" type="text/javascript"></script>
    <script>
        ...
        $(document).ready(function () {
            ...
            $.getScript("/Scripts/THDateEdit.js")
        ...
        function SetSeedIdBySelected() {
            ...
            //}
            if (cmbSeedType.GetSelectedIndex() != 0) {
                alert(cmbSeedType.GetValue());
                seedType = FormatNumberLength(cmbSeedType.GetValue(), 2);
                SeedTypeIDGrobal = seedType;
            }
    ...
    <form id="form1" runat="server">
        ...
        <div id="div_main">
            <div id="div_text_header">
                บัญชีรายการจ่ายเมล็ดพันธุ์ซื้อคืน (ดิบ)
            </div>
            ...
            <div style="padding: 5px;">
                ...
                <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="เลขที่จ่าย" FieldName="PickNo" VisibleIndex="8" Name="PickNo">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="จ่ายเพื่อ" FieldName="PickType" VisibleIndex="9" Name="PickType">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="วันที่จ่ายเมล็ดพันธุ์" Name="PickDate" FieldName="PickDate" VisibleIndex="10">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            <DataItemTemplate>
                        ...
                        <dx:GridViewBandColumn Caption="รายการจ่าย" VisibleIndex="11">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="จำนวนกระสอบ/ถุง" Name="Bags" FieldName="Bags" VisibleIndex="0">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="น้ำหนัก (กก.)" Name="Quantity" FieldName="Quantity" VisibleIndex="1">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                            </Columns>
