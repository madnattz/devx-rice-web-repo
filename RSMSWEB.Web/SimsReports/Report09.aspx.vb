...
Public Class Report09
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            'cmbSeedStatus.SelectedIndex = 2
            'cmbSeedStatus.SelectedItem = cmbSeedStatus.Items.FindByText("ดี")
    ...
    Public Sub LoadData()
        Try
            ...
            Dim cmd As String = "SP_Sims_Report09_SaleSeed"
    ...
    Protected Sub btnExportData_Click(sender As Object, e As EventArgs) Handles btnExportData.Click
        LoadData()
        ASPxGridViewExporter1.WriteXlsToResponse(Date.Today.ToString("ddMMyy") & "_รายงานการจำหน่ายเมล็ดพันธุ์ ", True)
