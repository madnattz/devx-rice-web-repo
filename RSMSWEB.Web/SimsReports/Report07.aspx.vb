...
Public Class Report07
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            cmbSeedStatus.SelectedIndex = 3
            cmbSeedStatus.SelectedItem = cmbSeedStatus.Items.FindByText("คัดออกใช้ประโยชน์ได้")
    ...
    Public Sub LoadData()
        Try
            ...
            Dim cmd As String = "SP_Sims_Report07_RelateSeedInventory"
    ...
    Protected Sub btnExportData_Click(sender As Object, e As EventArgs) Handles btnExportData.Click
        LoadData()
        ASPxGridViewExporter1.WriteXlsToResponse(Date.Today.ToString("ddMMyy") & "_บัญชีเมล็ดพันธุ์คัดออกจากกระบวนการผลิต", True)
