<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report13.aspx.vb" Inherits=".Report13" %>
...
<head id="Head1" runat="server">
    <title>รายงานที่ 13 รายงานการโอนเมล็ดพันธุ์ </title>
            ...
            <div id="div_search_panel">
                ...
                <div style="margin-left: 5px; padding: 5px;">
                    <table>
                        ...
                        <tr>
                            <td>
                                <label>โอนเพื่อ :</label>
                            </td>
                            <td>
                                <dx:ASPxComboBox ID="cmbTransferReason" runat="server" ClientInstanceName="cmbTransferReason" ValueType="System.String">
                                    <Items>
