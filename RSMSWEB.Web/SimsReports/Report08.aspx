<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report08.aspx.vb" Inherits=".Report08" %>
...
<head id="Head1" runat="server">
    <title>รายงานที่ 8 รายงานสถานการณ์ตลาดและคลังเมล็ดพันธุ์</title>
    ...
    <form id="form1" runat="server">
        ...
        <div id="div_main">
            <div id="div_text_header">
                รายงานสถานการณ์ตลาดและคลังเมล็ดพันธุ์
            </div>
                    ...
                    <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="เมล็ดพันธุ์คงคลัง" VisibleIndex="7">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewBandColumn Caption="การสำรอง" VisibleIndex="2">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <Columns>
