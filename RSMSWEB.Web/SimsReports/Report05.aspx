<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report05.aspx.vb" Inherits=".Report05" %>
...
<head runat="server">
    <title>รายงานที่ 5 บัญชีเมล็ดพันธุ์ซื้อคืน (ดิบ) คงคลัง</title>
    ...
    <form id="form1" runat="server">
        ...
        <div id="div_main">
            <div id="div_text_header">
                บัญชีเมล็ดพันธุ์ซื้อคืน (ดิบ) คงคลัง
            </div>
            <div id="div_search_panel">
                <span id="dsh_header">
                    <img id="img1" src="/Images/togleup.gif" style="padding-right: 5px;" title="เปิด" />
                    <label id="lblComment" class="SubHead2">เมล็ดพันธุ์ : X-1-XX-X-X-XXXX-X-XXX</label>
                </span>
                <div id="divSeedID">
                    <table>
                        <tr>
            ...
            <div style="padding: 5px;">
                ...
                <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="รายการรับ" VisibleIndex="8">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="กระสอบ/ถุง" Name="BagsIn" FieldName="BagsIn" VisibleIndex="0">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="น้ำหนัก (กก.)" Name="Income" FieldName="Income" VisibleIndex="1">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                            </Columns>
                        ...
                        <dx:GridViewBandColumn Caption="รายการจ่าย" VisibleIndex="9">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="กระสอบ/ถุง" Name="BagsOut" FieldName="BagsOut" VisibleIndex="0">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="น้ำหนัก (กก.)" Name="Outcome" FieldName="Outcome" VisibleIndex="1">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                            </Columns>
                    ...
                    <TotalSummary>
                        <dx:ASPxSummaryItem FieldName="BagsIn" ShowInColumn="BagsIn" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="Income" ShowInColumn="Income" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="BagsOut" ShowInColumn="BagsOut" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="Outcome" ShowInColumn="Outcome" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="TotalBags" ShowInColumn="TotalBags" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                        <dx:ASPxSummaryItem FieldName="TotalStockAmount" ShowInColumn="TotalStockAmount" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                    </TotalSummary>
