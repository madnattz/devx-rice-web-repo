<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report07.aspx.vb" Inherits=".Report07" %>
...
<head id="Head1" runat="server">
    <title>รายงานที่ 7 บัญชีเมล็ดพันธุ์คัดออกจากกระบวนการผลิต</title>
    ...
    <form id="form1" runat="server">
        ...
        <div id="div_main">
            <div id="div_text_header">
                บัญชีเมล็ดพันธุ์คัดออกจากกระบวนการผลิต
            </div>
            <div id="div_search_panel">
                <span id="dsh_header">
                    <img id="img1" src="/Images/togleup.gif" style="padding-right: 5px;" title="เปิด" />
                    <label id="lblComment" class="SubHead2">เมล็ดพันธุ์ : X-3-XX-X-X-XXXX-X-XXX</label>
                </span>
                <div id="divSeedID">
                    <table>
                        <tr>
                            ...
                            <td colspan="5">
                                <dx:ASPxTextBox ID="txtSeedId" runat="server" ClientInstanceName="txtSeedId" Width="170px" Text="X3XXXXXXXXXXXX">
            ...
            <div style="padding: 5px;">
                ...
                <dx:ASPxGridView ID="gvData" ClientInstanceName="gvData" Width="100%" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="เมล็ดพันธุ์คัดลอกใช้ประโยชน์ได้" VisibleIndex="7">
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="เลขที่รับ" Name="ReceiveNo" FieldName="ReceiveNo" VisibleIndex="0">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="วันที่รับ" Name="ReceiveDate" FieldName="ReceiveDate" VisibleIndex="1">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <DataItemTemplate>
                                        <%#DataUtil.GatDateString(Eval("ReceiveDate"))%>
                                    </DataItemTemplate>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="จำนวนรับ (ก.ก.)" Name="ReceiveQuantity" FieldName="ReceiveQuantity" VisibleIndex="2">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="เลขที่จ่าย" Name="PickNo" FieldName="PickNo" VisibleIndex="3">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="วันที่จ่าย" Name="PickDate" FieldName="PickDate" VisibleIndex="4">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <DataItemTemplate>
                                        <%#DataUtil.GatDateString(Eval("PickDate"))%>
                                    </DataItemTemplate>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="จำนวนจ่าย (ก.ก.)" Name="PickQuantity" FieldName="PickQuantity" VisibleIndex="5">
                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                    <PropertiesTextEdit DisplayFormatString="N0"></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                            </Columns>
                    ...
                    <TotalSummary>
                        ...
                        <dx:ASPxSummaryItem FieldName="PickQuantity" ShowInColumn="PickQuantity" SummaryType="Sum" DisplayFormat="<b>{0:N0}</b>" />
                    </TotalSummary>
