Public Class KP5ReportData
    ...
    Private _KP5ReportDetails As List(Of KP5ReportDetail)
    ...
    Public Property SubmitBy As String
        ...
        End Set
    End Property
    Public Property KP5ReportDetails As List(Of KP5ReportDetail)
        Get
            Return _KP5ReportDetails
        End Get
        Set(value As List(Of KP5ReportDetail))
            _KP5ReportDetails = value
        End Set
    End Property
