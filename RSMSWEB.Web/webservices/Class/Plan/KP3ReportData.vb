Public Class KP3ReportData
    ...
    Private _KP3ReportDetails As List(Of KP3ReportDetail)
    ...
    Public Property SubmitBy As String
        ...
        End Set
    End Property
    Public Property KP3ReportDetails As List(Of KP3ReportDetail)
        Get
            Return _KP3ReportDetails
        End Get
        Set(value As List(Of KP3ReportDetail))
            _KP3ReportDetails = value
        End Set
    End Property
