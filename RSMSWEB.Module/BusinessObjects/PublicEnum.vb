...
Public Class PublicEnum
    ...
    Public Enum SubmitReportCheck
        <XafDisplayName("เปิดการส่งรายงาน")>
        Open = 0
        <XafDisplayName("ปิดการส่งรายงาน")>
        Close = 1
    End Enum

    Public Enum EnumQuarter
        <XafDisplayName("ไตรมาส1")>
        Quarter1 = 1
        <XafDisplayName("ไตรมาส2")>
        Quarter2 = 2
        <XafDisplayName("ไตรมาส3")>
        Quarte3 = 3
        <XafDisplayName("ไตรมาส4")>
        Quarter4 = 4
    End Enum
