...
<DefaultClassOptions(), XafDisplayName("งบประมาณสงป. 301")> _
...
<Index(0)> _
    ...
    Private _PlantName As SettingPlan
    <XafDisplayName("ชื่อแผนงาน")> _
    <Index(1)> _
    <RuleRequiredField(DefaultContexts.Save)> _
    Public Property PlantName() As SettingPlan
        Get
            Return _PlantName
        End Get
    ...
    <DataSourceProperty("PlantName.SettingProjects")> _
...
#Region "==========Association============"
    ...
    <XafDisplayName("รายละเอียดกิจกรรมและแผนดำเนินงาน(ส่วนกลาง)")> _
