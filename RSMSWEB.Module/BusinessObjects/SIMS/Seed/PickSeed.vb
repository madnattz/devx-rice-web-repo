            ...
            Try
                ...
                For i As Integer = 0 To PickSeedDetails.Count - 1
                    If PickSeedDetails(i).SeedProduct IsNot Nothing Then
                        ...
                        Dim objTransactionLog As New SeedTransaction(_session, PublicEnum.SeedTransactionType.CancelPick, fPickNo, PickSeedDetails(i).SeedProduct, PickSeedDetails(i).Quantity, PickSeedDetails(i).Bags)
