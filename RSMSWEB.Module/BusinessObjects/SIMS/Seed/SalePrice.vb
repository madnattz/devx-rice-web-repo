...
<XafDisplayName("ราคาจำหน่ายเมล็ดพันธุ์")> _
Public Class SalePrice ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    <XafDisplayName("ราคาจำหน่าย (บาท)")> _
    ...
    <RuleRequiredField(DefaultContexts.Save)> _
    <XafDisplayName("วันที่บังคับใช้")> _
    ...
    <XafDisplayName("ชื่อผู้ปรับปรุงข้อมูล")> _
    ...
    <XafDisplayName("วันที่ปรับปรุงข้อมูล่าสุด")> _
