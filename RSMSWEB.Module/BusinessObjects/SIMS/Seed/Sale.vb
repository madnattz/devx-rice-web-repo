            ...
            Try
                ...
                For i As Integer = 0 To SaleDetails.Count - 1
                    If SaleDetails(i).SeedProduct IsNot Nothing Then
                        ...
                        End If
                        '//รายการเคลื่อนไหวคลัง
                        Dim objTransactionLog As New SeedTransaction(_session, PublicEnum.SeedTransactionType.CancelSale, fSaleNo, SaleDetails(i).SeedProduct, SaleDetails(i).Quantity, SaleDetails(i).Bags)
