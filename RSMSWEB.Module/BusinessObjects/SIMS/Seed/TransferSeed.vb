            ...
            Try
                ...
                For i As Integer = 0 To TransferSeedDetails.Count - 1
                    If TransferSeedDetails(i).SeedProduct IsNot Nothing Then
                        ...
                        '// Insert Transaction Data
                        Dim objTransactionLog As New SeedTransaction(_session, PublicEnum.SeedTransactionType.CancelTransferOut, fTransferNo, TransferSeedDetails(i).SeedProduct, TransferSeedDetails(i).Quantity, TransferSeedDetails(i).Bags)
                    End If
                Next
                Return True
            Catch ex As Exception
