            ...
            Try
                ...
                For Each item As ReserveSeedDetail In ReserveSeedDetails
                    If Not item.SeedProduct Is Nothing Then
                        ...
                        Dim objTransactionLog As New SeedTransaction(_session, PublicEnum.SeedTransactionType.CancelReserve, fReserveNo, item.SeedProduct, item.Quantity, item.Bags)
