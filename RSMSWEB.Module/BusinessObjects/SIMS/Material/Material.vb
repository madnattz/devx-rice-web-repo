...
Public Class Material ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Public Overrides Sub AfterConstruction()
        ...
        MaterialType = PublicEnum.MaterialType.ProcessMaterail
